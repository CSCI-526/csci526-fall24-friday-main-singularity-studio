...
public class SceneRotationSpeedrun : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        cameraOffset = GameObject.Find("Main Camera").GetComponent<CameraSpeedrun>().cameraYaxisOffset;
    }
        ...
        if(currentTime >= nextRotateTime){
            ...
            if(rotationProgress < 1 && rotationProgress >= 0){
                ...
                if(isVertical){
                    ...
                    transform.RotateAround(cameraTransform.position - new Vector3(0, cameraOffset, 0), Vector3.forward, 90.0f * Time.deltaTime);
                }
                else{
